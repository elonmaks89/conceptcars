...
<div id="container">
    ...
    <div id="content">
        ...
        <table id="brandinp" align="center">
            <thead>
            <tr id="choosebutt">
                <th align="left" style="min-width: 100px">Имя</th>
                <th align="center" style="min-width: 100px">Роль</th>
                <th align="right" style="min-width: 100px"></th>
            </tr>
            </thead>
            <tbody>
            <#list users as user>
                <tr id="choosebutt">
                    <td align="left" style="min-width: 100px">${user.username}</td>
                    <td align="center" style="min-width: 100px"><#list user.roles as role>${role}<#sep>, </#list></td>
                    <td align="right" style="min-width: 100px"><a href="/user/${user.id}">редактировать</a></td>
                </tr>
            </#list>
            </tbody>
        </table>
